...
//Edited By:Shakhan 1-4-08 Small change, If Werewolf is Human double click will change it into
//the CuSidhe instead of mounting. This comes in handy for quick stabling and animal lore.
using System;
	...
	public class Werewolf : BaseMount
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			if ( from.InRange( this, 1 ) )
			{
				...
				if ( canAccess )
				{
                    //If werewolf is human, transform it. Begin
