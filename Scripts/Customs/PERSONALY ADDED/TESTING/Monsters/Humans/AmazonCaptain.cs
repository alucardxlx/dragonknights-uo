...
namespace Server.Mobiles
{
	...
	public class AmazonCaptain : BaseCreature
	{
		[Constructable]
		public AmazonCaptain() : base( AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
			Name = NameList.RandomName( "savage" );
			Body = 184;
			Title = "the amazon captain";
		...
		public AmazonCaptain( Serial serial ) : base( serial )
		{
		}
