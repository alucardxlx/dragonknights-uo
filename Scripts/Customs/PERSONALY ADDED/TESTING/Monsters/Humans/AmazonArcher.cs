...
namespace Server.Mobiles
{
	...
	public class AmazonArcher : BaseCreature
	{
		[Constructable]
		public AmazonArcher() : base( AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
			Name = NameList.RandomName( "savage" );
			Body = 184;
			Title = "the amazon archer";
			...
			SetSkill( SkillName.Archery, 87.1, 94.0 );
		...
		public AmazonArcher( Serial serial ) : base( serial )
		{
		}
