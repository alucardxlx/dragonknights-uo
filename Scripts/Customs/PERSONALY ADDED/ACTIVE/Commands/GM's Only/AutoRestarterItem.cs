...
namespace Server.Items
{
	public class AutoRestarter : Item
	{
		...
		[Constructable]
		public AutoRestarter() : base(13920)
		{
			Name = "the Server time restarter";
			Visible = false;
			Movable = false;
	...
	public class I_Auto_Restarter4 : Timer
	{
		...
		{
			World.Broadcast( 0x22, true, "WARNING:" );
			World.Broadcast( 0x22, true, "The server will be restarting in 2 minutes." );
	...
	public class I_Auto_Restarter5 : Timer
	{
		...
		{
			World.Broadcast( 0x22, true, "WARNING:" );
			World.Broadcast( 0x22, true, "The server will be restarting in 1 minute." );
	...
	public class I_Auto_RestarterA : Timer
	{
		...
		{
			World.Broadcast( 0x22, true, "WARNING:" );
			World.Broadcast( 0x22, true, "The server will be restarting in 30 seconds." );
