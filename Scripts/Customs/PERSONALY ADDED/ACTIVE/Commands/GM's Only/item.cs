...
namespace Server.Gumps
{
    public class ItemPicker : Gump
    {
        ...
        public ItemPicker(int firstItem) : base( 0, 0 )
        {
            ...
            this.Dragable=true;
            AddPage(0);
            AddBackground(0, 0, 920, 650, 9200);
        ...
        //    AddTextEntry(700, 5,  200, 20, 0, 0, item);
            ...
            AddButton(330, 4, 2118, 2117, 20001, GumpButtonType.Reply, 0);
            AddLabel(345, 5, 0, @"1");
            AddButton(360, 4, 2118, 2117, 20002, GumpButtonType.Reply, 0);
            AddLabel(375, 5, 0, @"2");
            AddButton(390, 4, 2118, 2117, 20003, GumpButtonType.Reply, 0);
            AddLabel(405, 5, 0, @"3");
            AddButton(420, 4, 2118, 2117, 20004, GumpButtonType.Reply, 0);
            AddLabel(435, 5, 0, @"4");
            AddButton(450, 4, 2118, 2117, 20005, GumpButtonType.Reply, 0);
            AddLabel(465, 5, 0, @"5");
            AddButton(480, 4, 2118, 2117, 20006, GumpButtonType.Reply, 0);
            AddLabel(495, 5, 0, @"6");
            AddButton(510, 4, 2118, 2117, 20007, GumpButtonType.Reply, 0);
            AddLabel(525, 5, 0, @"7");
            AddButton(540, 4, 2118, 2117, 20008, GumpButtonType.Reply, 0);
            AddLabel(555, 5, 0, @"8");
            AddButton(570, 4, 2118, 2117, 20009, GumpButtonType.Reply, 0);
            AddLabel(585, 5, 0, @"9");
            AddButton(600, 4, 2118, 2117, 20010, GumpButtonType.Reply, 0);
            AddLabel(615, 5, 0, @"10");
            AddButton(630, 4, 2118, 2117, 20011, GumpButtonType.Reply, 0);
            AddLabel(645, 5, 0, @"11");
            AddButton(660, 4, 2118, 2117, 20012, GumpButtonType.Reply, 0);
            AddLabel(675, 5, 0, @"12");
            AddButton(690, 4, 2118, 2117, 20013, GumpButtonType.Reply, 0);
            AddLabel(705, 5, 0, @"13");
            AddButton(720, 4, 2118, 2117, 20014, GumpButtonType.Reply, 0);
            AddLabel(735, 5, 0, @"14");
            AddButton(750, 4, 2118, 2117, 20015, GumpButtonType.Reply, 0);
            AddLabel(765, 5, 0, @"15");
            AddButton(780, 4, 2118, 2117, 20016, GumpButtonType.Reply, 0);
            AddLabel(795, 5, 0, @"16");
            AddButton(810, 4, 2118, 2117, 20017, GumpButtonType.Reply, 0);
            AddLabel(825, 5, 0, @"17");
            ...
            while(itemCount <= 1000)
            {
                ...
                while(rowCount <= 6)
                {
                    while(colCount <= 18)
                    {
                        ...
                        AddButton(ButtonX, ButtonY, 2474, 2473, itemID, GumpButtonType.Reply, 0);
