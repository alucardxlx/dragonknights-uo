...
namespace Server.Gumps
{
    public class PasswordChanger : Gump
    {
		...
		{
			CommandSystem.Register ( "account-password-changer", AccessLevel.Player, new CommandEventHandler ( Password_OnCommand ) );
		}
       ...
       public PasswordChanger() : base(0, 0)
       {
           ...
           this.AddBackground(133, 77, 414, 206, 2600);

           this.AddLabel(279, 97, 1178, @"Account Password Changer");
           ...
           this.AddTextEntry( 321, 130, 200, 20, 0, 1, "");
           this.AddTextEntry( 321, 160, 200, 20, 0, 2, "");
           this.AddTextEntry( 321, 190, 200, 20, 0, 3, "");
       }
       ...
       public override void OnResponse(NetState sender, RelayInfo info)
       {
            ...
            switch (info.ButtonID)
            {
            	case 0:
            		{
            			m.SendMessage(37, "Your password has not been changed.");//1300 = black?
            			return;
            		}
            	case 1:
            		{
            			...
            			{
            				m.SendMessage(37, "The Current Password value: [ " + origPass + " ] is incorrect. Remember it is case sensative.");
            				m.CloseGump( typeof( PasswordChanger ) );
            				m.SendGump( new PasswordChanger() );
            				return;
            			}
