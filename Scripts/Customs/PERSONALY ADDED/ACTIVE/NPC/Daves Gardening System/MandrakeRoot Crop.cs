...
{ 
	public class MandrakeRootSeed : BaseCrop 
	{ 
		...
		[Constructable]
		public MandrakeRootSeed() : this( 1 )
		{
		}

		[Constructable]
		public MandrakeRootSeed( int amount ) : base( 0xF27 ) //seed graphic
		{
			Stackable = true; 
			Weight = .5; 
			Hue = 0x5E2; 
			...
			Amount = amount;
			Name = "MandrakeRoot Seed"; // I MODED
		}
		...
		{ 
			...
			this.Consume(); 
			Item item = new MandrakeRootSeedling( from ); 
			item.Location = m_pnt; 
			item.Map = m_map; 
			
		} 

		public MandrakeRootSeed( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class MandrakeRootSeedling : BaseCrop 
	{ 
		...
		[Constructable] 
		public MandrakeRootSeedling( Mobile sower ) : base( 0x913 )//I MODED Seedling Graphic Just planted  "dirt mound picture"
		{ 
			Movable = false; 
			Name = "MandrakeRoot Seedling"; 
			m_sower = sower;
			
			init( this );
		} 

		public static void init( MandrakeRootSeedling plant )
		{
			plant.thisTimer = new CropHelper.GrowTimer( plant, typeof(MandrakeRootCrop), plant.Sower ); //I MODED
		...
		public MandrakeRootSeedling( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class MandrakeRootCrop : BaseCrop //I MODED
	{ 
		...
		[Constructable] 
		public MandrakeRootCrop( Mobile sower ) : base( 0x18DE ) //I MODED Plant full size?
		{ 
			Movable = false; 
			Name = "MandrakeRoot Plant"; //I MODED
			...
			if ( DateTime.Now > lastpicked.AddSeconds(1) ) // 3 seconds between picking changed to 1 sec
			{
				...
				{ 
					...
					else //check skill and sower
					{
						...
						MandrakeRoot crop = new MandrakeRoot( pick ); //I MODED
