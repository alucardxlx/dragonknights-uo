...
{ 
	...
	{ 
		...
		[Constructable]
		public PumpkinSeed( int amount ) : base( 0xF27 ) //seed graphic
		{
			Stackable = true; 
			Weight = .5; 
			Hue = 0x5E2; 
	...
	{ 
		...
		[Constructable] 
		public PumpkinSeedling( Mobile sower ) : base( 0x913 )//I MODED Seedling Graphic Just planted  "dirt mound picture"
		{ 
			Movable = false; 
	...
	public class PumpkinCrop : BaseCrop //I MODED
	{ 
		...
		[Constructable] 
		public PumpkinCrop( Mobile sower ) : base( 0xc60 ) //I MODED Plant full size?
		{ 
			Movable = false; 
			Name = "Pumpkin Plant"; //I MODED
		...
		public static void init ( PumpkinCrop plant, bool full )//I MODED
		{
			plant.PickGraphic = ( 0xc5e );//I MODDED Picked Graphic
			plant.FullGraphic = ( 0xc60 );//I MODED Full plant graphic
		...
		{
			private PumpkinCrop i_plant; //I MODED

			public CropTimer( PumpkinCrop plant ) : base( TimeSpan.FromSeconds( 600 ), TimeSpan.FromSeconds( 15 ) )//I MODED
			{
