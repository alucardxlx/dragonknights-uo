...
{ 
	public class GrapesSeed : BaseCrop 
	{ 
		...
		[Constructable]
		public GrapesSeed() : this( 1 )
		{
		}

		[Constructable]
		public GrapesSeed( int amount ) : base( 0xF27 ) //seed graphic
		{
			Stackable = true; 
			Weight = .5; 
			Hue = 0x5E2; 
		...
		{ 
			...
			this.Consume(); 
			Item item = new GrapesSeedling( from ); 
			item.Location = m_pnt; 
			item.Map = m_map; 
			
		} 

		public GrapesSeed( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class GrapesSeedling : BaseCrop 
	{ 
		...
		[Constructable] 
		public GrapesSeedling( Mobile sower ) : base( 0x913 )//I MODED Seedling Graphic Just planted  "dirt mound picture"
		{ 
			Movable = false; 
			Name = "Grapes Seedling"; 
			m_sower = sower;
			
			init( this );
		} 

		public static void init( GrapesSeedling plant )
		{
			plant.thisTimer = new CropHelper.GrowTimer( plant, typeof(GrapesCrop), plant.Sower ); //I MODED
		...
		public GrapesSeedling( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class GrapesCrop : BaseCrop //I MODED
	{ 
		...
		[Constructable] 
		public GrapesCrop( Mobile sower ) : base( 0xD1E ) //I MODED Plant full size?
		{ 
			Movable = false; 
			Name = "Grapes Plant"; //I MODED
		...
		public GrapesCrop( Serial serial ) : base( serial ) 
		{ 
		} 
