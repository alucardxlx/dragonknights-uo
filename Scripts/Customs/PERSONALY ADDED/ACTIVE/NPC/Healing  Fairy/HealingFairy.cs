...
namespace Server.Mobiles
{
	public class HealingFairy : BaseHealer
	{
		...
		public DateTime TimeToDie{ get { return m_TimeToDie; } set { m_TimeToDie = value; }}
		...
		public HealingFairy()
		{
			...
			Hue = 96;  //Never found a hue I was very happy with... 2050 if you want an annoying white glow.
			...
			Fame = 7000;
			Karma = 7000;
			m_TimeToDie = DateTime.Now + TimeSpan.FromSeconds(45);
		}

		public override void OnThink()
			{
			if ( m_TimeToDie <= DateTime.Now )
				{
				...
				PublicOverheadMessage( 0, 96, true, "Haha, you failed to catch me with the \"Fairy Jar\", I got away! Na na na boo boo!" );
//				SendMessage("You failed to capture the healing fairy, using a special \"Fairy Jar\", and it gets away.");
				this.Delete();
...
//				Say( 501223 ); // Thou'rt not a decent and good person. I shall not resurrect thee.
				Say("You are not nice, but I will give you a chance.");
				return true;
			}
			else if ( m.Karma < 0 )
			{
...
//			Delete();
		...
		public override void Serialize( GenericWriter writer )
		{
			...
			writer.Write( (int) 0 ); // version
			 if (DateTime.Now > this.TimeToDie)
			 	this.Delete();
