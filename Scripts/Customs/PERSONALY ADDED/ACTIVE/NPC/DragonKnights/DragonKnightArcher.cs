...
{ 
	[CorpseName( "a DragonKnight Archers corpse" )] 
	public class DragonKnightArcher : BaseCreature 
	{
		[Constructable]
		public DragonKnightArcher() : base( AIType.AI_Melee, FightMode.Evil, 10, 1, 0.2, 0.4 ) 
		{
 			Title = "a DragonKnight Archer";
...
//		public override bool AlwaysMurderer{ get{ return true; } }
		...
		public DragonKnightArcher( Serial serial ) : base( serial )
		{
		}
