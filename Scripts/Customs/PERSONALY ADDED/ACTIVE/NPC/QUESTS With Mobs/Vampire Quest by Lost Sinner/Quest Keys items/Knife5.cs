...
{ 
	[FlipableAttribute( 0xF52, 0xF51 )]
   	public class VampKnife5: Item 
   	{ 
		[Constructable]
		public VampKnife5() : base( 0xF52 ) 
		{
			ItemID = 2550;
			Weight = 0.1;
			Name = "A Holy Blade";
			...
			if ( !IsChildOf( from.Backpack ) )
			{
				from.SendLocalizedMessage( 1042001 ); // That must be in your pack for you to use it.
                        ...
                        { 
                                from.BeginTarget( -1, false, TargetFlags.Harmful, new TargetCallback( VampKnife5Target_Callback ) );
				from.SendMessage( "Target the corpse of Serraphim." );
			}         
		}

            	public VampKnife5( Serial serial ) : base ( serial ) 
            	{             
           	} 
