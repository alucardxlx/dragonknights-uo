...
namespace Server.Items
{
	...
	public class VampiresMinionGloves : BaseArmor
	{
		...
		[Constructable]
		public VampiresMinionGloves() : base( 0x1450 )
		{
			Name = "Minion's Gloves";
			Weight = 2.0;
			Hue = 1175;
            SkillBonuses.SetValues(0, SkillName.Necromancy, 1.0);
		}

		public VampiresMinionGloves( Serial serial ) : base( serial )
		{
		}
