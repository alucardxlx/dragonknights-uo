...
{
	public class plus1necromancygem : Item
	{
		[Constructable]
		public plus1necromancygem() : this( 1 )
		{
		}

		[Constructable]
		public plus1necromancygem( int amount ) : base( 0x186E )
		{
			Stackable = false;
			Weight = 0.1;
			Amount = amount;
			Hue = 0;
			Name = "+1 Necromancy Skill Gem"; 
		}

		public plus1necromancygem( Serial serial ) : base( serial )
		{
		}
		...
		{
			private plus1necromancygem m_cOrb;
			public InternalTarget( plus1necromancygem cOrb ) :  base ( 8, false, TargetFlags.None )
			{
				m_cOrb = cOrb;
				AllowNonlocal = true;
			}
