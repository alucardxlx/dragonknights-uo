/*
	...
	Edits: To edit the default corpse retrieval cost, please go to line 35, and 
		change the number 400 in,  this( 400 ) to the cost you want default 
		wands to have!!

	ENJOY!!

Edited to make into a wand by: AlphaDragon
*/
...
//namespace Server.Gumps
{
	...
	public class CorpseWand : Item
	{
		...
		[Constructable]
		public CorpseWand() : this( 400 )
		{
		}

		[Constructable]
		public CorpseWand( int price ) : base( 0xED4 )
		{
			Movable = true;
			Hue = 1152;
			Name = "A Corpse Wand";
		...
		public CorpseWand( Serial serial ) : base( serial )
		{
		}
		...
		{		   				
			...
			public override void OnResponse( NetState state, RelayInfo info )
			{
				...
				Item corpse=from.Corpse;
                      	  	if ( corpse!=null && corpse.Map == from.Map )
				{
					...
					if ( m_Price > 0 )
					{
						...
						{
							from.SendMessage( "You decide against paying the fee, leaving your corpse behind." ); 
							from.CantWalk = false;
							return;
						}
