...
{
	public class SmallFireworksStand : Item
	{
		...
		[Constructable]
		public SmallFireworksStand() : base( 0x24BE )
		{
			Name = "Small Fireworksstand";
			Hue = 1355;
			m_Charges = 5;
		}

		public SmallFireworksStand( Serial serial ) : base( serial )
		{
		}
