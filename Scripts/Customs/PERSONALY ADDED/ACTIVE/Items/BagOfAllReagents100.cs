...
{
	public class BagOfAllReagents100 : Bag
	{
		[Constructable]
		public BagOfAllReagents100() : this( 100 )
		{
		}

		[Constructable]
		public BagOfAllReagents100( int amount )
		{
		...
		public BagOfAllReagents100( Serial serial ) : base( serial )
		{
		}
