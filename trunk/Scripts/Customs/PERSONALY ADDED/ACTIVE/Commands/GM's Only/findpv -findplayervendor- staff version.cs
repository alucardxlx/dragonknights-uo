...
namespace Server.Gumps
{
    public class FindPlayerVendorsGump : Gump
    {
        ...
        {
            CommandSystem.Register( "FindPV", AccessLevel.GameMaster, new CommandEventHandler( FindPlayerVendors_OnCommand ) );
        }

        [Usage( "FindPV" )]
        [Description( "Finds all Player Vendors in the world." )]
...
//            AddLabel( 27, 298, 32, String.Format( "Made By Sidious    Version 1.0.0                       There are {0} vendors in the world.", pvs ));
            AddLabel( 27, 298, 32, String.Format( "Staff Version no restrictions.                         There are {0} vendors in the world.", pvs ));
