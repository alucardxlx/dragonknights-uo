...
namespace Server.Forums
{
	public class ForumGump : Gump
	{
		...
		public ForumGump( Mobile pm, int page ) : base( 0, 0 )
		{
            ...
            AddImage( 636, 53, 5536 );
//            AddBlackAlpha( 80, 63, 549, 63 );//******************
			AddImageTiled(80, 63, 549, 63, 2624);
			AddImageTiled(80, 144, 491, 354, 2624);

            AddImage( 655, 368, 10411 );//help but
            AddImage( 657, 195, 10410 );
            AddImage( 21, 481, 10402 );
            AddButton( 579, 239, 4008, 4008, ( int )Buttons.CreditsButton, GumpButtonType.Reply, 0 );
            AddButton( 580, 279, 4014, 4014, ( int )Buttons.HelpButton, GumpButtonType.Reply, 0 );
            ...
            AddLabel( 612, 240, 0, "Credits" );
            AddLabel( 614, 281, 0, "Help" );
            AddLabel( 87, 68, 55, "DragonKnights in game Forums   Total Threads: " + ForumCore.Threads.Count.ToString() + " Total Moderators: " + ForumCore.Moderators.Count.ToString() );
            AddLabel( 87, 93, 55, "Users Online: " + NetState.Instances.Count );
//            AddLabel( 535, 101, 499, "Version " + ForumCore.Version );
            AddLabel( 80, 124, 0, "   Posts              Subject                    Views/Replys" );
