...
{
	public class MediumFireworksStand : Item
	{
		...
		[Constructable]
		public MediumFireworksStand() : base( 0x24BE )
		{
			Name = "Medium Fireworksstand";
			Hue = 1355;
			m_Charges = 10;
		}

		public MediumFireworksStand( Serial serial ) : base( serial )
		{
		}
