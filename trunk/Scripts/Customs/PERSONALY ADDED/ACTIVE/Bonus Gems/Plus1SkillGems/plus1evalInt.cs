...
{
	public class plus1evalintgem : Item
	{
		[Constructable]
		public plus1evalintgem() : this( 1 )
		{
		}

		[Constructable]
		public plus1evalintgem( int amount ) : base( 0x186E )
		{
			Stackable = false;
			Weight = 0.1;
			Amount = amount;
			Hue = 0;
			Name = "+1 Eval Int Skill Gem"; 
		}

		public plus1evalintgem( Serial serial ) : base( serial )
		{
		}
		...
		{
			private plus1evalintgem m_cOrb;
			public InternalTarget( plus1evalintgem cOrb ) :  base ( 8, false, TargetFlags.None )
			{
				m_cOrb = cOrb;
				AllowNonlocal = true;
			}
