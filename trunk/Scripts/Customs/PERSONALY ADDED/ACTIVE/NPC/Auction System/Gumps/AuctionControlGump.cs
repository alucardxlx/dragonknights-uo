...
namespace Arya.Auction
{
	...
	public class AuctionControlGump : Gump
	{
		...
		private void MakeGump()
		{
			...
			AddLabel(99, 15, 273, AuctionSystem.ST[ 213 ] );
			AddImageTiled(15, 35, 270, 1, 9304);
			AddImageTiled(30, 55, 1, 65, 9304);

			// Auction owner
			bool owner = m_Auction.Owner != null;
			AddLabel(15, 35, 33, string.Format( AuctionSystem.ST[ 216 ], owner ? m_Auction.Owner.Name : AuctionSystem.ST[ 78 ] ));
			...
			AddLabel(55, 55, 88, AuctionSystem.ST[ 214 ] );;
			...
			AddLabel(55, 75, 88, string.Format( AuctionSystem.ST[ 215 ], ( owner && m_Auction.Owner.Account != null ) ? ( m_Auction.Owner.Account as Server.Accounting.Account ).Username : AuctionSystem.ST[ 78 ] ) );
