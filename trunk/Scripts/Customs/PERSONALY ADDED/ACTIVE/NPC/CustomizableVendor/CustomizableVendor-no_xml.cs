...
public class Currency : Item
{
    ...
    {
//ORIGINAL        if ( (t is Mobile) || append == null )// trying to clean up yellows, Mobile is never an item error
        if ( append == null )
            return;
    ...
    public void VOneUpdate()
    {
        switch (m_PaymentType)
        {
            ...
            case Payment.ByProperty:
                {
//ORIGINAL                    if (!(m_Type is Mobile))//trying to clean up yellow messages - Mobile is never a type.
//                    if (!(m_Type is Mobile))
...
public class EditItemGump : Gump
{
    ...
    public EditItemGump(IRewardVendor vendor, Reward r, Storage entries, bool openRestockInfo, bool addingItem) : base(0, 0)
    {
		...
		AddBackground(227, 46, 329, 518, 2620);
        AddImageTiled(252, 291, 280, 217, 9384);
        AddLabel(253, 266, 2124, @"Description:");
        AddImageTiled(334, 147, 192, 23, 9384);
        AddLabel(258, 150, 2124, @"Cost:");
        AddImageTiled(336, 107, 192, 23, 9384);
        AddLabel(258, 108, 2124, @"Name:");
        AddImage(354, 199, 2328);
        AddItem(373, 208, r.RewardInfo.ItemID, r.RewardInfo.Hue);
        AddLabel(363, 55, 38, @"Edit Item Menu");
    ...
    {
        AddTextEntry(252, 292, 277, 215, 0, 0, m_Reward.Description);
        AddTextEntry(334, 148, 188, 20, 0, 1, m_Reward.Cost.ToString());
        AddTextEntry(336, 108, 188, 20, 0, 2, m_Reward.Title);    
    }
    public void PacketText()
    {
        AddTextEntry(252, 292, 277, 215, 0, 0, m_Entries[0].ToString()); //desc
        AddTextEntry(334, 148, 188, 20, 0, 1, m_Entries[1].ToString());  //cost 
        AddTextEntry(336, 108, 188, 20, 0, 2, m_Entries[2].ToString());  //title
    }
    public void AddRestockMenu()
    {
        ...
        AddLabel(648, 60, 38, @"Restock Info");
        AddLabel(637, 98, 1418, @"Available");
        AddImageTiled(633, 123, 120, 16, 9384);
        AddTextEntry(637, 121, 107, 20, 0, 3, (m_Restock == null ? "Enter." : m_Restock.Count.ToString())); //3 - beginning amount
        AddLabel(660, 161, 1418, @"Maximum");
        AddImageTiled(631, 186, 120, 16, 9384);
        AddTextEntry(635, 184, 107, 20, 0, 4, ((m_Restock == null || m_Restock.Maximum < 0) ? "None." : m_Restock.Maximum.ToString())); //4 - Maxinum
        AddLabel(648, 227, 1418, @"Restock Rate");
        AddImageTiled(635, 252, 72, 16, 9384);
        AddTextEntry(638, 250, 64, 20, 0, 5, (m_Restock == null ? "0" : m_Restock.Hours.ToString())); //5 - hour
        AddLabel(714, 250, 602, @"hours");
        AddImageTiled(635, 292, 72, 16, 9384);
        AddLabel(716, 290, 602, @"mins");
        AddLabel(632, 323, 602, @"amount to restock");
        AddImageTiled(636, 355, 72, 16, 9384);
        AddTextEntry(638, 290, 64, 20, 0, 6, (m_Restock == null ? "0" : m_Restock.Minutes.ToString())); //6 - minute
        AddTextEntry(639, 353, 64, 20, 0, 7, (m_Restock == null ? "0" : m_Restock.RestockAmnt.ToString())); //7 - Restock Amount      
    ...
    public override void OnResponse(NetState sender, RelayInfo info)
    {
        ...
        m.SendSound(1224);// 1224= click noise
...
public class ViewItemGump : Gump
{
        ...
        : base(0, 0)
    {
        ...
        AddPage(0);//player view item page
        AddBackground(149, 207, 548, 277, 2620);
        ...
        AddLabel(231, 444, 2125, "Buy");
        AddButton(366, 442, 4020, 4021, 0, GumpButtonType.Reply, 0); //cancel
        AddLabel(407, 444, 2116, @"Cancel");
        AddImageTiled(184, 239, 510, 8, 9201);

        AddLabel(182, 369, 83, "This cost: " + r.Cost +" "+m_Vendor.Payment.PayName);
        AddItem(182, 396, m_Vendor.Payment.PayID, m_Vendor.Payment.CurrHue);


        AddLabel(184, 268, 43, @"Vendor: " + m_Vendor.GetName());
        AddLabel(363, 216, 2123, r.RewardCopy.Amount +" "+r.Title);
        ...
        {
        	//Open display m seems to open the box to show the player and gms how it looks in a box.
          //  OpenDisplay(m); //prevent build up of box display during editing
        }

        //Edit gump for display object
        if (viewItem) //not display
        {//dusplays view item button on view item window LEO
...
public class WorldVendorsGump : Gump
{
    ...
    public WorldVendorsGump(IRewardVendor vendor) : base( 242, 34 )
    {
        m_Vendor = vendor;
        ...
        try
        {
            if (info.ButtonID % 2 == 0 ) //even ID: Copy Vendor
            {
                ...
                else
                {
                    ...
                    m.SendSound(910);//glass break- warning 1224= click noise
...
public class InfoGump : Gump
{
    ...
    public InfoGump(Mobile m, IRewardVendor vendor)
        : base(0, 34)
    {
    	m_Vendor = vendor;
		...
		AddBackground(0, 0, 452, 516, 2620);
...
//        AddItem(391, 467, 8451);// immage of a cow
        ...
        AddButton(190, 485, 12006, 12008, 0, GumpButtonType.Reply, 0); // Close Button help window
...
//        AddImage(40, 8, 5214);LEO!!!
        AddLabel(70, 7, 38, @"Control Panel");
        ...
        AddButton(77, 505, 2033, 2032, 4, GumpButtonType.Reply, 0);//help button call infogump
        AddButton(70, 543, 12006, 12008, 0, GumpButtonType.Reply, 0); // Control gump close button
        ...
        AddImageTiled(12, 382, 156, 22, 9304);
        AddTextEntry(16, 382, 149, 20, 0, 0, @"[prop Name Here");
    ...
    public override void OnResponse(NetState sender, RelayInfo info)
    {
        ...
        switch (info.ButtonID)
        {
            ...
            case 1: //PlayerView - Manage rewards
                {
                    m.CloseGump(typeof(WorldVendorsGump));
                    MenuUploader.Display(m_Vendor.Menu, m, m_Vendor, true);
                    break;
                }
            case 2: //AddItem - or container
                {
                    m.CloseGump(typeof(WorldVendorsGump));
            ...
            case 4://Call help gump
                {
        			m.CloseGump(typeof(InfoGump));
                    MenuUploader.Display(m_Vendor.Menu, m, m_Vendor, false);
                    m.SendGump(new InfoGump(m, m_Vendor));
                    break;
                }
            case 5: //Displays
                {
                    ...
                    m.AddToBackpack(c);
                    m.SendSound (310);//drop container sound
                    MenuUploader.Display(m_Vendor.Menu, m, m_Vendor, false);
...
public class ManageItemsGump : JewlRewardGump
{
    ...
    public override void AddEntryControl(Reward r)
    {
        ...
        //create entry
        AddLabel(227, PosY, 2123, r.RewardCopy.Amount +" "+r.Title);
...
//        AddImageTiledButton(227, (PosY + 26), 2328, 2329, ++m_ButtonNum, GumpButtonType.Reply, PageNum, b.ItemID, b.Hue, 15, 10, r.Display.Header);
        AddImageTiledButton(227, (PosY + 26), 2328, 2329, ++m_ButtonNum, GumpButtonType.Reply, PageNum, b.ItemID, b.Hue, 15, 10);
...
public class JewlRewardGump : Gump, IRewardVendorGump
{
    ...
    public virtual void CreateBackgroundControl()
    {
        ...
        AddButton(349, 558, 12006, 12008, 0, GumpButtonType.Reply, 0); // Close Button player view list of items
    ...
    public virtual void AddEntryControl(Reward r)
    {
        ...
        AddLabel(227, m_PosY, 2123, r.RewardCopy.Amount +" "+r.Title);
...
//        AddImageTiledButton(227, (m_PosY + 26), 2328, 2329, (m_EntryNum), GumpButtonType.Reply, m_PageNum, b.ItemID, b.Hue, 15, 10, b.LocalizedTooltip);
        AddImageTiledButton(227, (m_PosY + 26), 2328, 2329, (m_EntryNum), GumpButtonType.Reply, m_PageNum, b.ItemID, b.Hue, 15, 10);
...
//        m_Menu = typeof(ClassicVendorGump);//LEO
		CantWalk = true;
        m_Menu = typeof(JewlRewardGump);//LEO
