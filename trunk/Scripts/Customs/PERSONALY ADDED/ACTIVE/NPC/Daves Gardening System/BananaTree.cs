...
namespace Server.Items.Crops
{
	public class BananaTree : Item
	{
		...
		private class FruitTimer : Timer
		{
			...
			public FruitTimer( BananaTree plant ) : base( TimeSpan.FromSeconds( 1200 ), TimeSpan.FromSeconds( 45 ) )
			{
		...
		public BananaTree( Serial serial ) : base( serial )
		{
		}
