...
{ 
	...
	{ 
		...
		{ 
			...
			if ( DateTime.Now > lastpicked.AddSeconds(1) ) // 3 seconds between picking changed to 1
			{
		...
		private class CropTimer : Timer
		{
			...
			public CropTimer( FlaxCrop plant ) : base( TimeSpan.FromSeconds( 600 ), TimeSpan.FromSeconds( 15 ) )
			{
