...
{ 
	...
	{ 
		...
		[Constructable]
		public NightshadeSeed( int amount ) : base( 0xF27 ) //seed graphic
		{
			Stackable = true; 
			Weight = .5; 
			Hue = 0x5E2; 
	...
	{ 
		...
		[Constructable] 
		public NightshadeSeedling( Mobile sower ) : base( 0x913 )//I MODED Seedling Graphic Just planted  "dirt mound picture"
		{ 
			Movable = false; 
		...
		{
			plant.thisTimer = new CropHelper.GrowTimer( plant, typeof(NightshadeCrop), plant.Sower ); //I MODED
	...
	public class NightshadeCrop : BaseCrop //I MODED
	{ 
		...
		[Constructable] 
		public NightshadeCrop( Mobile sower ) : base( 0xf88 ) //I MODED Plant full size?
		{ 
			Movable = false; 
			Name = "Nightshade Plant"; //I MODED
