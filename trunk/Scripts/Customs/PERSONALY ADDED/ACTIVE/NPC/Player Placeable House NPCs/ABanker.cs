...
#region
		public override void GetContextMenuEntries( Mobile from,  List<ContextMenuEntry> list )
		{
			...
			if ( house != null && from.Alive )
			{
				...
				{
					ABanker.GetContextMenuEntries( from, this, list );//HERE
				}
		...
		{
			list.Add( new ABankerCancelMenu( from, vendor ) );//HERE
		}

		private class ABankerCancelMenu : ContextMenuEntry//HERE
		{
			private BaseVendor m_Vendor;
			private Mobile m_Mobile;

			public ABankerCancelMenu(Mobile from, BaseVendor vendor) : base(6129, 3) //Dismissal //HERE
			{
				m_Vendor = vendor as ABanker;//HERE
				m_Mobile = from;
			}
			public override void OnClick()
			{
				m_Vendor.Delete();
				m_Mobile.AddToBackpack( new ABankerContract() );//HERE
			}
		}
#endregion
