...
#region
		public override void GetContextMenuEntries( Mobile from,  List<ContextMenuEntry> list )
		{
			...
			if ( house != null && from.Alive )
			{
				...
				{
					AAnimalTrainer.GetContextMenuEntries( from, this, list );//HERE
				}
		...
		{
			list.Add( new AAnimalTrainerCancelMenu( from, vendor ) );//HERE
		}

		private class AAnimalTrainerCancelMenu : ContextMenuEntry//HERE
		{
			...
			{
				m_Vendor.Delete();
				m_Mobile.AddToBackpack( new AAnimalTrainerContract() );//HERE
			}
		}
#endregion
