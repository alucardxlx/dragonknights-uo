...
namespace Server.Mobiles
{
	public class SBjunkbuyer: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo> 
		{
			...
			{
				Add( new GenericBuyInfo("Empty Fairy Jar", typeof(HealingFairyJar), 1000, 10, 0x1005, 0x482 ) ); 
...
Add( typeof( HardenedWildStaff ), 2 );
...
Add( typeof( Torso ), 2 );
Add( typeof( TribalBerry ), 1 );
Add( typeof( TribalMask ), 1 );
Add( typeof( TribalPaint ), 2 );
Add( typeof( TribalSpear ), 1 );
