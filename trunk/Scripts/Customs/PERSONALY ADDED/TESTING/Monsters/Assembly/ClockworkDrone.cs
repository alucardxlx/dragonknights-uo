...
namespace Server.Mobiles
{
	...
	public class ClockworkDrone : BaseCreature
	{
		...
		[Constructable]
		public ClockworkDrone() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public ClockworkDrone( Serial serial ) : base( serial )
		{
		}
