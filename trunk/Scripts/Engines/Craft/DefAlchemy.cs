...
//I added start
				...
				//mana potions
				index = AddCraft( typeof( LesserManaPotion ), 1074832, "Lesser Mana Potion", 55.0, 105.0, typeof( MandrakeRoot ), "Mandrake Root", 10, "You do not have sufficent mandrake roots to make that." );
				AddRes( index, typeof ( Bottle ), 1044529, 1, 500315 );

				index = AddCraft( typeof( ManaPotion ), 1074832, "Mana Potion", 70.0, 120.0, typeof( MandrakeRoot ), "Mandrake Root", 20, "You do not have sufficent mandrake roots to make that." );
				AddRes( index, typeof ( Bottle ), 1044529, 1, 500315 );
